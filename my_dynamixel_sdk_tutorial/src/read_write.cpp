...
#define ADDR_PRO_TORQUE_ENABLE          24 //64//562                 // Control table address is different in Dynamixel model
#define ADDR_PRO_GOAL_POSITION          30 //116//596
#define ADDR_PRO_PRESENT_POSITION       36 //132//611

// Protocol version
#define PROTOCOL_VERSION                1.0 //2.0                 // See which protocol version is used in the Dynamixel

// Default setting
#define DXL_ID                          1                   // Dynamixel ID: 1
#define BAUDRATE                        1000000 //57600
#define DEVICENAME                      "/dev/ttyUSB0" //"/dev/ttyACM0"      // Check which port is being used on your controller
...
//  goal_position[0] = msg->position.at(0);
  ROS_INFO("%f", msg->position.at(0));

//  for (int index = 0; index < dxl_cnt_; index++){
//      dxl_comm_result = packetHandler->write4ByteTxRx(portHandler, DXL_ID, ADDR_PRO_GOAL_POSITION, dxl_goal_position[1], &dxl_error);
//      dxl_comm_result = packetHandler->write4ByteTxRx(portHandler, DXL_ID, ADDR_PRO_GOAL_POSITION, dxl_goal_position[0], &dxl_error);
